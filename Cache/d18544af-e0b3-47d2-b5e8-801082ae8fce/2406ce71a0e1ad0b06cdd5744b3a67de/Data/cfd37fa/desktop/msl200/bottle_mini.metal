...
//}
//ubo int UserUniforms 0:47:5504 {
...
//spec_const bool SC_USE_UV_MIN_MAX_detailNormalTex 37
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38
//spec_const bool SC_USE_UV_MIN_MAX_normalTex 39
//spec_const bool SC_USE_UV_MIN_MAX_opacityTex 40
//spec_const bool SC_USE_UV_TRANSFORM_baseTex 41
//spec_const bool SC_USE_UV_TRANSFORM_detailNormalTex 42
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 43
//spec_const bool SC_USE_UV_TRANSFORM_normalTex 44
//spec_const bool SC_USE_UV_TRANSFORM_opacityTex 45
//spec_const bool Tweak_N11 46
//spec_const bool Tweak_N121 47
//spec_const bool Tweak_N218 48
//spec_const bool Tweak_N308 49
//spec_const bool Tweak_N354 50
//spec_const bool Tweak_N37 51
//spec_const bool Tweak_N67 52
//spec_const bool UseViewSpaceDepthVariant 53
//spec_const bool baseTexHasSwappedViews 54
//spec_const bool detailNormalTexHasSwappedViews 55
//spec_const bool intensityTextureHasSwappedViews 56
//spec_const bool normalTexHasSwappedViews 57
//spec_const bool opacityTexHasSwappedViews 58
//spec_const bool sc_BlendMode_AddWithAlphaFactor 59
//spec_const bool sc_BlendMode_Add 60
//spec_const bool sc_BlendMode_AlphaTest 61
//spec_const bool sc_BlendMode_AlphaToCoverage 62
//spec_const bool sc_BlendMode_ColoredGlass 63
//spec_const bool sc_BlendMode_Custom 64
//spec_const bool sc_BlendMode_Max 65
//spec_const bool sc_BlendMode_Min 66
//spec_const bool sc_BlendMode_MultiplyOriginal 67
//spec_const bool sc_BlendMode_Multiply 68
//spec_const bool sc_BlendMode_Normal 69
//spec_const bool sc_BlendMode_PremultipliedAlphaAuto 70
//spec_const bool sc_BlendMode_PremultipliedAlphaHardware 71
//spec_const bool sc_BlendMode_PremultipliedAlpha 72
//spec_const bool sc_BlendMode_Screen 73
//spec_const bool sc_DepthOnly 74
//spec_const bool sc_EnvmapDiffuseHasSwappedViews 75
//spec_const bool sc_EnvmapSpecularHasSwappedViews 76
//spec_const bool sc_FramebufferFetch 77
//spec_const bool sc_HasDiffuseEnvmap 78
//spec_const bool sc_LightEstimation 79
//spec_const bool sc_MotionVectorsPass 80
//spec_const bool sc_OITCompositingPass 81
//spec_const bool sc_OITDepthBoundsPass 82
//spec_const bool sc_OITDepthGatherPass 83
...
//spec_const bool sc_UseFramebufferFetchMarker 94
//spec_const bool sc_VertexBlendingUseNormals 95
//spec_const bool sc_VertexBlending 96
//spec_const bool uv2EnableAnimation 97
//spec_const bool uv3EnableAnimation 98
...
constant bool SC_USE_UV_MIN_MAX_detailNormalTex [[function_constant(37)]];
...
constant bool SC_USE_UV_MIN_MAX_opacityTex [[function_constant(40)]];
...
constant bool SC_USE_UV_TRANSFORM_detailNormalTex [[function_constant(42)]];
...
constant bool SC_USE_UV_TRANSFORM_opacityTex [[function_constant(45)]];
...
constant bool detailNormalTexHasSwappedViews [[function_constant(55)]];
...
constant bool normalTexHasSwappedViews [[function_constant(57)]];
...
constant bool opacityTexHasSwappedViews [[function_constant(58)]];
...
constant bool sc_ProxyAlphaOne [[function_constant(86)]];
constant bool sc_ProxyAlphaOne_tmp = is_function_constant_defined(sc_ProxyAlphaOne) ? sc_ProxyAlphaOne : false;
constant bool sc_RayTracedAoTextureHasSwappedViews [[function_constant(87)]];
...
constant bool sc_RayTracedDiffIndTextureHasSwappedViews [[function_constant(88)]];
...
float3 param_24=(*sc_set0.UserUniforms).Port_Emissive_N036;
float3 param_25=(*sc_set0.UserUniforms).Port_AO_N036;
...
float l9_2604=param_22;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_2604<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_2605=gl_FragCoord;
float2 l9_2606=floor(mod(l9_2605.xy,float2(4.0)));
float l9_2607=(mod(dot(l9_2606,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_2604<l9_2607)
{
discard_fragment();
}
...
float4 l9_2622=fast::max(param_28,float4(0.0));
float4 param_29=l9_2622;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_BlendMode_PremultipliedAlpha_tmp)!=0))
{
l9_2625=fast::clamp(l9_2624.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_2625=fast::clamp(dot(l9_2624.xyz,float3(l9_2624.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
if ((int(sc_BlendMode_Multiply_tmp)!=0))
{
l9_2625=(1.0-dot(l9_2624.xyz,float3(0.33333001)))*l9_2624.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2625=(1.0-fast::clamp(dot(l9_2624.xyz,float3(1.0)),0.0,1.0))*l9_2624.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_2625=fast::clamp(dot(l9_2624.xyz,float3(1.0)),0.0,1.0)*l9_2624.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_2625=fast::clamp(dot(l9_2624.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_2625=dot(l9_2624.xyz,float3(0.33333001))*l9_2624.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_2625=1.0-fast::clamp(dot(l9_2624.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_2626=l9_2625;
float l9_2627=l9_2626;
float l9_2628=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_2627;
float3 l9_2629=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_2623.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_2630=float4(l9_2629.x,l9_2629.y,l9_2629.z,l9_2628);
param_30=l9_2630;
}
else
{
...
{
float4 l9_2631=param_30;
float4 l9_2632=float4(0.0);
float4 l9_2633=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_2634=out.FragColor0;
float4 l9_2635=l9_2634;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_2635.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_2637=gl_FragCoord;
float2 l9_2638=l9_2637.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_2639=l9_2638;
...
{
l9_2642=in.varStereoViewID;
}
int l9_2643=l9_2642;
int l9_2644=l9_2643;
float3 l9_2645=float3(l9_2639,0.0);
int l9_2646=l9_2641;
int l9_2647=l9_2644;
if (l9_2646==1)
{
l9_2645.y=((2.0*l9_2645.y)+float(l9_2647))-1.0;
}
float2 l9_2648=l9_2645.xy;
l9_2640=l9_2648;
}
else
{
...
float2 l9_2649=l9_2640;
float2 l9_2650=l9_2649;
float2 l9_2651=l9_2650;
int l9_2652=0;
if ((int(sc_ScreenTextureHasSwappedViews_tmp)!=0))
{
int l9_2653=0;
...
{
l9_2655=in.varStereoViewID;
}
int l9_2656=l9_2655;
l9_2652=l9_2656;
}
int l9_2657=l9_2652;
float2 l9_2658=l9_2651;
int l9_2659=l9_2657;
float2 l9_2660=l9_2658;
int l9_2661=l9_2659;
float l9_2662=0.0;
float4 l9_2663=float4(0.0);
float2 l9_2664=l9_2660;
int l9_2665=sc_ScreenTextureLayout_tmp;
int l9_2666=l9_2661;
float l9_2667=l9_2662;
float2 l9_2668=l9_2664;
int l9_2669=l9_2665;
int l9_2670=l9_2666;
float3 l9_2671=float3(0.0);
if (l9_2669==0)
{
l9_2671=float3(l9_2668,0.0);
}
else
{
if (l9_2669==1)
{
l9_2671=float3(l9_2668.x,(l9_2668.y*0.5)+(0.5-(float(l9_2670)*0.5)),0.0);
}
else
{
l9_2671=float3(l9_2668,float(l9_2670));
}
}
float3 l9_2672=l9_2671;
float3 l9_2673=l9_2672;
float2 l9_2674=l9_2673.xy;
float l9_2675=l9_2667;
float4 l9_2676=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_2674,bias(l9_2675));
float4 l9_2677=l9_2676;
l9_2663=l9_2677;
float4 l9_2678=l9_2663;
float4 l9_2679=l9_2678;
float4 l9_2680=l9_2679;
l9_2633=l9_2680;
}
float4 l9_2681=l9_2633;
float4 l9_2682=l9_2681;
float3 l9_2683=l9_2682.xyz;
float3 l9_2684=l9_2683;
float3 l9_2685=l9_2631.xyz;
float3 l9_2686=definedBlend(l9_2684,l9_2685,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_2632=float4(l9_2686.x,l9_2686.y,l9_2686.z,l9_2632.w);
float3 l9_2687=mix(l9_2683,l9_2632.xyz,float3(l9_2631.w));
l9_2632=float4(l9_2687.x,l9_2687.y,l9_2687.z,l9_2632.w);
l9_2632.w=1.0;
float4 l9_2688=l9_2632;
param_30=l9_2688;
}
else
{
float4 l9_2689=param_30;
float4 l9_2690=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_2690=float4(mix(float3(1.0),l9_2689.xyz,float3(l9_2689.w)),l9_2689.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_2691=l9_2689.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_2691=fast::clamp(l9_2691,0.0,1.0);
}
l9_2690=float4(l9_2689.xyz*l9_2691,l9_2691);
}
else
{
l9_2690=l9_2689;
...
float4 l9_2692=l9_2690;
param_30=l9_2692;
}
}
}
float4 l9_2693=param_30;
FinalColor=l9_2693;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_2694=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_2694=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_31,param_32,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_33=FinalColor;
float4 l9_2696=param_33;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_2696.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_2696;
return out;
}
} // FRAGMENT SHADER
