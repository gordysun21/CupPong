...
//}
//ubo int UserUniforms 0:31:4320 {
...
//float Port_Input1_N017 4148
//float3 Port_Import_N039 4160
//float Port_Multiplier_N022 4176
//float Port_Import_N040 4180
//float3 Port_Import_N038 4192
//float2 Port_Scale_N013 4208
//float2 Port_Scale_N015 4216
//float2 Port_Scale_N020 4224
//float Port_Input1_N000 4232
//float Port_Input1_N029 4236
//float Port_Input1_N003 4240
//float Port_Input1_N056 4244
//float Port_Input1_N055 4248
//float4 Port_Value_N023 4256
//float Port_Input1_N010 4272
//float Port_Input0_N062 4276
//float Port_Input1_N059 4280
//float Port_Input1_N061 4284
//float Port_Input2_N061 4288
//float Port_Input1_N019 4292
//float Port_Input1_N049 4296
//float Port_Input2_N049 4300
//float depthRef 4304
//}
...
float3 Normal_N48=float3(0.0);
ssGlobals param_1=Globals;
bool l9_7=(*sc_set0.UserUniforms).isProxyMode!=0;
float3 param;
if (l9_7)
{
param=CalculateProxyFaceNormal((*sc_set0.UserUniforms),sc_set0.z_hitIdAndBarycentric,sc_set0.z_hitIdAndBarycentricSmp,gl_FragCoord,(*sc_set0.layoutVertices),(*sc_set0.layoutVerticesPN),(*sc_set0.layoutIndices));
}
else
{
float3 l9_8=param_1.SurfacePosition_WorldSpace;
float3 l9_9=float3(dfdx(l9_8.x),dfdx(l9_8.y),dfdx(l9_8.z));
float3 l9_10=float3(dfdy(l9_8.x),dfdy(l9_8.y),dfdy(l9_8.z));
param=cross(l9_9,l9_10);
param/=float3(length(param));
}
Normal_N48=param;
float3 Output_N16=float3(0.0);
Output_N16=Normal_N48+float3(1.0);
float3 Output_N17=float3(0.0);
Output_N17=Output_N16/float3((*sc_set0.UserUniforms).Port_Input1_N017);
float3 Camera_Right_N51=float3(0.0);
int l9_11=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_11=0;
...
int l9_12=l9_11;
Camera_Right_N51=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_12][0].xyz);
float3 Value_N39=float3(0.0);
Value_N39=Camera_Right_N51;
float Time_N22=0.0;
Time_N22=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N022;
float Output_N53=0.0;
Output_N53=radians(Time_N22);
float Value_N40=0.0;
Value_N40=Output_N53;
float Output_N43=0.0;
Output_N43=cos(Value_N40);
float Output_N32=0.0;
Output_N32=Output_N43-Value_N40;
float3 Camera_Up_N64=float3(0.0);
int l9_13=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_13=0;
...
int l9_14=l9_13;
Camera_Up_N64=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_14][1].xyz);
float3 Value_N38=float3(0.0);
Value_N38=Camera_Up_N64;
float Output_N45=0.0;
Output_N45=dot(Value_N39,Value_N38);
float Output_N34=0.0;
Output_N34=Output_N32*Output_N45;
float3 Output_N35=float3(0.0);
Output_N35=Value_N39*float3(Output_N34);
float3 Output_N37=float3(0.0);
Output_N37=float3(Output_N43)*Value_N38;
float Output_N42=0.0;
Output_N42=sin(Value_N40);
float3 Result_N44=float3(0.0);
Result_N44=cross(Value_N39,Value_N38);
float3 Output_N36=float3(0.0);
Output_N36=float3(Output_N42)*Result_N44;
float3 Output_N41=float3(0.0);
Output_N41=(Output_N35+Output_N37)+Output_N36;
float3 Export_N50=float3(0.0);
Export_N50=Output_N41;
float3 Normal_N69=float3(0.0);
ssGlobals param_3=Globals;
bool l9_15=(*sc_set0.UserUniforms).isProxyMode!=0;
float3 param_2;
if (l9_15)
{
param_2=CalculateProxyFaceNormal((*sc_set0.UserUniforms),sc_set0.z_hitIdAndBarycentric,sc_set0.z_hitIdAndBarycentricSmp,gl_FragCoord,(*sc_set0.layoutVertices),(*sc_set0.layoutVerticesPN),(*sc_set0.layoutIndices));
}
else
{
float3 l9_16=param_3.SurfacePosition_WorldSpace;
float3 l9_17=float3(dfdx(l9_16.x),dfdx(l9_16.y),dfdx(l9_16.z));
float3 l9_18=float3(dfdy(l9_16.x),dfdy(l9_16.y),dfdy(l9_16.z));
param_2=cross(l9_17,l9_18);
param_2/=float3(length(param_2));
}
Normal_N69=param_2;
float2 Output_N12=float2(0.0);
Output_N12=float2(Output_N17.x,Output_N17.y);
float Random_N13=0.0;
Random_N13=fract(sin(dot(floor(Output_N12*(*sc_set0.UserUniforms).Port_Scale_N013),float2(0.98979998,0.72329998)))*437.58545);
Random_N13=floor(Random_N13*10000.0)*9.9999997e-05;
float2 Output_N14=float2(0.0);
Output_N14=float2(Output_N17.y,Output_N17.x);
float Random_N15=0.0;
Random_N15=fract(sin(dot(floor(Output_N14*(*sc_set0.UserUniforms).Port_Scale_N015),float2(0.98979998,0.72329998)))*437.58545);
Random_N15=floor(Random_N15*10000.0)*9.9999997e-05;
float2 Output_N18=float2(0.0);
Output_N18=float2(Output_N17.x,Output_N17.z);
float Random_N20=0.0;
Random_N20=fract(sin(dot(floor(Output_N18*(*sc_set0.UserUniforms).Port_Scale_N020),float2(0.98979998,0.72329998)))*437.58545);
Random_N20=floor(Random_N20*10000.0)*9.9999997e-05;
float3 Value_N33=float3(0.0);
Value_N33.x=Random_N13;
Value_N33.y=Random_N15;
Value_N33.z=Random_N20;
float3 Output_N0=float3(0.0);
Output_N0=Value_N33*float3((*sc_set0.UserUniforms).Port_Input1_N000);
float3 Output_N1=float3(0.0);
Output_N1=Output_N0-float3(1.0);
float3 Output_N29=float3(0.0);
Output_N29=Output_N1*float3((*sc_set0.UserUniforms).Port_Input1_N029);
float3 Output_N27=float3(0.0);
Output_N27=Normal_N69+Output_N29;
float3 Output_N11=float3(0.0);
float3 param_4=Output_N27;
float l9_19=dot(param_4,param_4);
float l9_20;
if (l9_19>0.0)
{
...
float l9_21=l9_20;
float3 param_5=param_4*l9_21;
Output_N11=param_5;
float Output_N8=0.0;
Output_N8=dot(Export_N50,Output_N11);
float Output_N30=0.0;
Output_N30=abs(Output_N8);
float Output_N3=0.0;
float l9_22;
if (Output_N30<=0.0)
{
...
{
l9_22=pow(Output_N30,(*sc_set0.UserUniforms).Port_Input1_N003);
}
Output_N3=l9_22;
float3 Camera_Up_N47=float3(0.0);
int l9_23=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_23=0;
...
int l9_24=l9_23;
Camera_Up_N47=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_24][1].xyz);
float3 Normal_N26=float3(0.0);
ssGlobals param_7=Globals;
bool l9_25=(*sc_set0.UserUniforms).isProxyMode!=0;
float3 param_6;
if (l9_25)
{
param_6=CalculateProxyFaceNormal((*sc_set0.UserUniforms),sc_set0.z_hitIdAndBarycentric,sc_set0.z_hitIdAndBarycentricSmp,gl_FragCoord,(*sc_set0.layoutVertices),(*sc_set0.layoutVerticesPN),(*sc_set0.layoutIndices));
}
else
{
float3 l9_26=param_7.SurfacePosition_WorldSpace;
float3 l9_27=float3(dfdx(l9_26.x),dfdx(l9_26.y),dfdx(l9_26.z));
float3 l9_28=float3(dfdy(l9_26.x),dfdy(l9_26.y),dfdy(l9_26.z));
param_6=cross(l9_27,l9_28);
param_6/=float3(length(param_6));
}
Normal_N26=param_6;
float Output_N46=0.0;
Output_N46=dot(Camera_Up_N47,Normal_N26);
float Output_N52=0.0;
Output_N52=abs(Output_N46);
...
{
l9_29=pow(Output_N52,(*sc_set0.UserUniforms).Port_Input1_N056);
}
Output_N56=l9_29;
float Output_N54=0.0;
Output_N54=Output_N3+Output_N56;
float Output_N55=0.0;
Output_N55=Output_N54/(*sc_set0.UserUniforms).Port_Input1_N055;
float4 Output_N23=float4(0.0);
Output_N23=(*sc_set0.UserUniforms).Port_Value_N023;
float4 Output_N24=float4(0.0);
Output_N24=float4(Output_N55)*Output_N23;
float4 Output_N10=float4(0.0);
Output_N10=Output_N24/float4((*sc_set0.UserUniforms).Port_Input1_N010);
float3 Output_N21=float3(0.0);
Output_N21=Output_N17+Output_N10.xyz;
float3 Camera_Position_N58=float3(0.0);
Camera_Position_N58=(*sc_set0.UserUniforms).sc_Camera.position;
float3 Position_N57=float3(0.0);
Position_N57=Globals.SurfacePosition_WorldSpace;
float Output_N60=0.0;
Output_N60=distance(Camera_Position_N58,Position_N57);
float Output_N59=0.0;
Output_N59=Output_N60/(*sc_set0.UserUniforms).Port_Input1_N059;
float Output_N61=0.0;
Output_N61=fast::clamp(Output_N59+0.001,(*sc_set0.UserUniforms).Port_Input1_N061+0.001,(*sc_set0.UserUniforms).Port_Input2_N061+0.001)-0.001;
float Output_N62=0.0;
Output_N62=(*sc_set0.UserUniforms).Port_Input0_N062-Output_N61;
float Output_N19=0.0;
Output_N19=fast::min(Output_N55,(*sc_set0.UserUniforms).Port_Input1_N019);
float Output_N5=0.0;
Output_N5=fast::max(Output_N62,Output_N19);
float Output_N49=0.0;
Output_N49=fast::clamp(Output_N5+0.001,(*sc_set0.UserUniforms).Port_Input1_N049+0.001,(*sc_set0.UserUniforms).Port_Input2_N049+0.001)-0.001;
float4 Value_N9=float4(0.0);
Value_N9=float4(Output_N21.x,Output_N21.y,Output_N21.z,Value_N9.w);
Value_N9.w=Output_N49;
FinalColor=Value_N9;
...
bool l9_33=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_33)
{
...
{
l9_37=fast::clamp(l9_36.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_37=fast::clamp(dot(l9_36.xyz,float3(l9_36.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_37=(1.0-dot(l9_36.xyz,float3(0.33333001)))*l9_36.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_37=(1.0-fast::clamp(dot(l9_36.xyz,float3(1.0)),0.0,1.0))*l9_36.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_37=fast::clamp(dot(l9_36.xyz,float3(1.0)),0.0,1.0)*l9_36.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_37=fast::clamp(dot(l9_36.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_37=dot(l9_36.xyz,float3(0.33333001))*l9_36.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_37=1.0-fast::clamp(dot(l9_36.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_38=l9_37;
float l9_39=l9_38;
float l9_40=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_39;
float3 l9_41=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_35.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_42=float4(l9_41.x,l9_41.y,l9_41.z,l9_40);
param_11=l9_42;
}
else
{
...
{
float4 l9_43=param_11;
float4 l9_44=float4(0.0);
float4 l9_45=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_46=out.FragColor0;
float4 l9_47=l9_46;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_47.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_48=l9_47;
l9_45=l9_48;
}
...
{
float4 l9_49=gl_FragCoord;
float2 l9_50=l9_49.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_51=l9_50;
...
int l9_55=l9_54;
int l9_56=l9_55;
float3 l9_57=float3(l9_51,0.0);
int l9_58=l9_53;
int l9_59=l9_56;
if (l9_58==1)
{
l9_57.y=((2.0*l9_57.y)+float(l9_59))-1.0;
}
float2 l9_60=l9_57.xy;
l9_52=l9_60;
}
else
{
...
float l9_87=l9_79;
float4 l9_88=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_86,bias(l9_87));
float4 l9_89=l9_88;
l9_75=l9_89;
float4 l9_90=l9_75;
float4 l9_91=l9_90;
...
float4 l9_93=l9_45;
float4 l9_94=l9_93;
float3 l9_95=l9_94.xyz;
float3 l9_96=l9_95;
float3 l9_97=l9_43.xyz;
float3 l9_98=definedBlend(l9_96,l9_97,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_44=float4(l9_98.x,l9_98.y,l9_98.z,l9_44.w);
float3 l9_99=mix(l9_95,l9_44.xyz,float3(l9_43.w));
l9_44=float4(l9_99.x,l9_99.y,l9_99.z,l9_44.w);
l9_44.w=1.0;
float4 l9_100=l9_44;
param_11=l9_100;
}
...
{
float4 l9_101=param_11;
float4 l9_102=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_102=float4(mix(float3(1.0),l9_101.xyz,float3(l9_101.w)),l9_101.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_103=l9_101.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_103=fast::clamp(l9_103,0.0,1.0);
}
l9_102=float4(l9_101.xyz*l9_103,l9_103);
}
else
{
l9_102=l9_101;
...
float4 l9_104=l9_102;
param_11=l9_104;
}
}
}
float4 l9_105=param_11;
FinalColor=l9_105;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_106=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_106=float4(0.0);
...
float4 l9_108=param_14;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_108.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_108;
return out;
}
} // FRAGMENT SHADER
